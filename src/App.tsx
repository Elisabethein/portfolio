  ...
  return (
    <>
      ...
      <div className="max-w-[90%] w-full">
        ...
        <section id="stack" className='scroll-mt-40'><Stack /></section>
        <section id="projects" className='scroll-mt-40'><Projects /></section>
        <section id="resume" className='scroll-mt-40'><Resume /></section>
